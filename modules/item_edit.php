...
# @package ExpItemEdit
# @descr
# 	Moduł edycji pojedynczego zakupu

class ExpItemEdit extends ExpAbstract {
	# @struct $item_name
	# @descr [string]
	# 	Nazwa zakupu
    ...
    # @function validate
    # @descr
    #   Sprawdzenie czy mamy dostępne w $_GET ID zakupu
    #
    # @input
    #   -
    #
    ...
    public function on_get () {
        ...
        $this->item_date_buy = date_reverse ($this->item_date_buy);
